      ...
      <section className="flex justify-center">
        <div className=" w-full font-sans">
          <section className="container-projects !bg-[#181818]">
            <div className="z-50">
              <p className="text-7xl mb-10 font-bold tracking-wide">Backend</p>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
          ...
          <div className="boxes backend-content text-[#d8d8d8]">
            {projectsData.map((project, index) => (
              ...
              >
                ...
                <h2>{project.title}</h2>
                <p className="piece-count">{project.tech}</p>
                <p className="description mr-2 mb-10 text-center lg:text-start">
                  {language === "en" ? project.descriptionEn : project.description}
                </p>
                <a
                  href={project.githubLink}
                  className="text-[#93b0c6] font-light"
                  target="_blank"
